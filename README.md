...
**Repository:** [https://github.com/cemkumrall/PACE-LS-CVRP-FPGA](https://github.com/cemkumrall/PACE-LS-CVRP-FPGA)  
**Archived release (Zenodo):** [10.5281/zenodo.22058605](https://doi.org/10.5281/zenodo.22058605)
...
The source code, CPU experiment outputs, profiling data, FPGA HLS sources, design-space exploration results, post-implementation reports, and physical hardware-validation artifacts supporting this study are publicly available in the GitHub repository:

**GitHub:** [https://github.com/cemkumrall/PACE-LS-CVRP-FPGA](https://github.com/cemkumrall/PACE-LS-CVRP-FPGA)

The archived research artifact is permanently available through Zenodo:

**Zenodo DOI:** [10.5281/zenodo.22058605](https://doi.org/10.5281/zenodo.22058605)

The repository also includes additional result figures reporting reliability across independent runs, final-gap distributions, CPU runtime distributions, and feasibility preservation.

Detailed descriptions of the repository structure and individual files are provided in this README. The CVRP benchmark instances used in the study are publicly available from the benchmark sources cited in the manuscript and are therefore not redistributed in this repository.
...
The archived research artifact is permanently available through Zenodo at [10.5281/zenodo.22058605](https://doi.org/10.5281/zenodo.22058605).
...
The research artifact associated with the manuscript has been archived on Zenodo and is permanently citable via [10.5281/zenodo.22058605](https://doi.org/10.5281/zenodo.22058605).
